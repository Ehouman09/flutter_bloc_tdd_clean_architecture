...
import 'package:educationapp/src/on_boarding/presentation/views/widgets/on_boarding_body.dart';
    ...
    return Scaffold(
        body: BlocConsumer<OnBoardingCubit, OnBoardingState>(
            ...
            builder:(context, state){
              ...
              if(state is CheckingIfFirstTimer || state is CachingFirstTimer){
